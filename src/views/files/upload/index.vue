  ...
  <div class="app-container list">
    <div ref="toolbar" class="toolbar">
      ...
      <div class="tool-group">
        ...
        <el-button class="tool tool-create" type="primary" icon="vue-icon-create" @click="handleCreate">上传</el-button>
...
export default {
  ...
  data() {
    ...
    const curPermission = this.$store.getters.access.file.upload
    return {
      ...getDefaultListViewData(), ...curModels, curApi, curPermission,
      ...{
        sort: { prop: 'upload_time', order: 'descending' },
        roleTypes: [],
        companies: [],
        departs: [],
        zhixis: [],
