  ...
  <div class="app-container list">
    <div ref="toolbar" class="toolbar">
      ...
      <div class="tool-group">
        ...
        <a href="http://localhost:9002/#/src/assets/tools.xlsx">上传格式下载</a>
    ...
    <el-table ref="listTable" v-loading="loading.table" v-adaptive="{ bottomOffset: 55 }" height="200px" :data="datas" :default-sort="sort" border fit highlight-current-row @sort-change="handleSort">
      ...
      <el-table-column label="量治具编号" prop="measureCode" align="left" width="200" show-overflow-tooltip />
      <el-table-column label="制造编号" prop="productCode" align="center" width="200" show-overflow-tooltip />
      <el-table-column label="名称" prop="name" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="品牌型号" prop="brand" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="制造日期" prop="productDate" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="验收日期" prop="checkDate" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="厂区" prop="factory" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="加工部" prop="processDept" align="left" show-overflow-tooltip />
      <el-table-column label="保管人" prop="responsePsersonName" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="保管单位" prop="responseDeptName" align="center" width="120" show-overflow-tooltip />
      <el-table-column label="使用状况" prop="status" align="center" width="120" show-overflow-tooltip />
...
export default {
  ...
  directives: { adaptive },
  data() {
    const curModels = models.tools.queryinfo
    const curApi = api.tools.queryInfo
    const curPermission = this.$store.getters.access.tools.queryinfo
    return {
