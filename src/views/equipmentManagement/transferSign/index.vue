  ...
  <div class="app-container list">
    <div ref="toolbar" class="toolbar">
      <div class="tool-group">
        ...
        <el-select v-model="query.applyDeptId" class="query-item" style="width: 150px" placeholder="查询单位" clearable @clear="handleQuery">
        ...
        <el-input v-model.trim="query.deviceNo" class="query-item" style="width: 120px" placeholder="设备编码" clearable @clear="handleQuery" />
        <el-input v-model.trim="query.opInfo" class="query-item" style="width: 120px" placeholder="设备编码" clearable @clear="handleQuery" />
        <!--        <el-select v-model="query.opInfo" class="query-item" style="width: 150px" placeholder="查询信息" clearable @clear="handleQuery">-->
      ...
      <div class="tool-group">
        ...
        <el-select v-model="query.processDeptId" class="query-item" style="width: 150px" placeholder="加工部" clearable @clear="handleQuery">
...
export default {
  ...
  data() {
    ...
    const curPermission = this.$store.getters.access.equipmentManagement.transfer
    return {
